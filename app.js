      ...
      <section class="panel">
        <div class="section-head">
          ...
          <div class="row-actions">
            <button class="soft-button" data-open="finance:tuition">Gerar mensalidade</button>
...
function costList(title, rows) {
  ...
  return `
    <section class="cost-list">
      ...
      <div class="stack">
        ${rows.length ? rows.map(financeRow).join("") : `<p class="empty">Nenhum lançamento nesta lista.</p>`}
      </div>
    </section>
  `;
}
...
function drawerTitle(kind, isEdit) {
  const names = { student: "aluno", class: "turma", wait: "interessado", workshop: "oficina", finance: "lançamento", tuition: "mensalidade", therapist: "terapeuta" };
